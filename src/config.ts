...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "289969440", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				...
				"/assets/desktop-banner/初音-初音未来.webp",
				"/assets/desktop-banner/Mikucover.webp",
	...
	favicon: [
		{
		   src: '/assets/home/Miku.png',    // 图标文件路径             // 可选，指定主题 'light' | 'dark'
		   sizes: '32x32',              // 可选，图标大小
		 }
		// 留空以使用默认 favicon
		// {
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/head.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: " 绘梨花",
...
export const musicPlayerConfig: MusicPlayerConfig = {
	...
	meting_api:
		"https://met.api.xiaoguan.fit/docs/server=[server]&type=[type]&id=[id]", // Meting API 地址
	id: "77115025", // 歌单ID
